...
b=d.map(this.getShortcuts(),function(a){return a.keystroke+" \u2014 "+a.label});a+=b.join("\n")+"\n\n";a+="More info on http://emmet.io/";a+= '\n\ndeveloed by m.alaei https://github.com/kaveh32';return a},showInfo:function(){alert(this.getInfo())},setup:function(a){this.setOptions(a)}}});